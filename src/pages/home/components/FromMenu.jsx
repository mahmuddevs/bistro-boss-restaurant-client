...
const FromMenu = () => {
    return (
        <>
            ...
            <section className="w-11/12 md:container mx-auto bg-[#151515] my-16 md:my-32">
                <h3 className="font-semibold text-5xl text-center text-white py-24">Call Us: +88 0192345678910</h3>
            </section>
        </>
    )
}
